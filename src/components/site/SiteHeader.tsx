  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full max-w-[1200px] items-center justify-between gap-6 px-6">
        ...
        <MotionButton
          href="#contact"
          className="hidden min-h-11 items-center justify-center rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground no-underline shadow-[0_4px_16px_color-mix(in_oklab,var(--primary)_22%,transparent)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-accent md:inline-flex"
        >
          Talk to an engineer
        </MotionButton>
